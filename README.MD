🛒 Retail Sales ETL Pipeline (Python, Pandas, SQLite, Scheduler)
...
git clone https://github.com/hthakral14/retailsales
cd retailsales
...
Due to large file size, full retail.db is not uploaded.
Run etl.py to recreate the DB locally.
